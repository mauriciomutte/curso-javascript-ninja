(function() {
  ...
  */
  ...
  console.log(text.replace(/Manuel Marques de Sousa/, 'Maurício Mutte'));
  ...
  */
  ...
  console.log(text.replace(/brasileiro/, 'porto alegrense'));
  ...
  */
  ...
  console.log(
    text.replace(/(O Centauro de Luvas)/, function(capturaTotal, cap1) {
  ...
  */
  ...
  function getMonthNumber(month) {
    const monthNames = ['janeiro', 'fevereiro', 'abril', 'março', 'maio', 'junho', 'julho', 'agosto', 'setembro', 'outubro', 'novembro', 'dezembro'];
    const validEnterMonth = month.toLowerCase();
    const monthNum = monthNames.indexOf(validEnterMonth) + 1
